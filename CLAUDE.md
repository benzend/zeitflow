...
This is a Next.js application that implements an AI chain processing system called "Joice". The application allows users to create, manage, and execute chains of AI prompts that are processed asynchronously.
