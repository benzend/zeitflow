      ...
      <div className="container mx-auto px-4 pb-8 pt-20 max-w-4xl">
        ...
        {editMode ? (
          ...
          <div className="rounded-lg mb-8">
            <h1 className="text-3xl font-bold text-[#a3e635] mb-4">Chain Details</h1>
        ...
        <div className="border-white border-1 rounded-lg shadow p-6">
          ...
          <p className="text-white">Chain steps will be displayed here once implemented.</p>
          {/* We'll implement chain steps in a future update */}
        </div>
        </main>
      </div>
    </div>
