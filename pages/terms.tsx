    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 mt-10">
        ...
        <div className="space-y-8">
          ...
          {/* 15. Content Liability & Platform Neutrality */}
          <section className="bg-surface border border-border rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">15. Content Liability &amp; Platform Neutrality</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium mb-2 text-foreground">Neutral Infrastructure Provider</h3>
                <p className="text-foreground leading-relaxed">
                  ZeitFlow is a neutral provider of technical infrastructure. Similar to social media platforms
                  and other intermediary services, we do not create, curate, edit, endorse, or control the content
                  generated through your AI workflows, chains, or templates. We provide the tools; you provide
                  the instructions. You are the sole &quot;publisher&quot; of any content produced by your use of the Service.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-medium mb-2 text-foreground">No Monitoring Obligation</h3>
                <p className="text-foreground leading-relaxed">
                  We are under no obligation to monitor, review, or pre-screen the content of user workflows,
                  prompts, AI-generated outputs, or Marketplace templates. While we reserve the right to review
                  and remove content that violates these Terms (see Sections 6 and 14), the absence of monitoring
                  does not imply endorsement or approval of any user-generated content.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-medium mb-2 text-foreground">User Responsibility for Content</h3>
                <p className="text-foreground leading-relaxed">
                  You acknowledge and agree that you are solely responsible for: (a) the content of your prompts
                  and workflow configurations; (b) any output generated by AI models based on your instructions;
                  (c) how you use, distribute, or publish that output; and (d) ensuring that your use of the
                  Service complies with all applicable laws and these Terms. Any legal claims arising from the
                  content you create, generate, or distribute through the Service — including but not limited to
                  claims of defamation, copyright infringement, or harmful content — are your sole responsibility.
                </p>
              </div>
            </div>
          </section>

          {/* 16. Sole Proprietor Acknowledgment */}
          <section className="bg-surface border border-border rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">16. Sole Proprietor Acknowledgment</h2>
            <p className="text-foreground leading-relaxed mb-4">
              By using this Service, you acknowledge that ZeitFlow is owned and operated by a sole proprietor.
              You expressly agree that you will not hold the owner personally liable for any content created,
              generated, hosted, or distributed by users of the Service, including but not limited to claims
              related to:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-foreground leading-relaxed">
              <li>Defamation or libel arising from AI-generated or user-generated content</li>
              <li>Copyright or intellectual property infringement by users or AI outputs</li>
              <li>Harmful, offensive, or illegal content created by or through user workflows</li>
              <li>Any losses or damages arising from third-party AI model outputs</li>
              <li>Actions taken by users that violate these Terms or applicable law</li>
            </ul>
            <p className="text-foreground leading-relaxed mt-4">
              This acknowledgment is a material condition of your use of the Service. If you do not agree
              to this provision, you must not use the Service.
            </p>
          </section>

          {/* 17. Termination */}
          <section className="bg-surface border border-border rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">17. Termination</h2>
            <p className="text-foreground leading-relaxed mb-4">
          ...
          {/* 18. Indemnification & Safe Harbor */}
          <section className="bg-surface border border-border rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">18. Indemnification &amp; Safe Harbor</h2>
            <p className="text-foreground leading-relaxed mb-4">
              You agree to indemnify, defend, and hold harmless ZeitFlow, its owner, and any agents,
              contractors, or representatives from and against any and all claims, liabilities, damages,
              losses, costs, and expenses (including reasonable attorney&apos;s fees, court costs, and
              settlement amounts) arising out of or in any way connected with:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-foreground leading-relaxed">
              <li>Your access to or use of the Service</li>
              <li>Your Content or any Output generated from Your Content</li>
              <li>Your violation of these Terms or any applicable law</li>
              <li>Your violation of any third-party rights, including intellectual property, privacy, or publicity rights</li>
              <li>Any claim by a third party related to content you created, generated, or distributed through the Service</li>
              <li>Any dispute between you and another user of the Service</li>
            </ul>
            <p className="text-foreground leading-relaxed mt-4">
              <strong>Under no circumstances may you pass legal liability to ZeitFlow or its owner for
              content-related claims.</strong> If your use of the Service results in legal action against
              ZeitFlow — including but not limited to lawsuits, regulatory complaints, or cease-and-desist
              demands — you are responsible for all legal fees, settlements, judgments, and associated costs
              incurred by ZeitFlow in connection with such action. This indemnification obligation survives
          ...
          <section className="bg-surface border border-border rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">19. Limitation of Liability</h2>
            <p className="text-foreground leading-relaxed mb-4">
          ...
          <section className="bg-surface border border-border rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">20. Dispute Resolution</h2>
            <p className="text-foreground leading-relaxed mb-4">
          ...
          {/* 21. Data Protection Commitment */}
          <section className="bg-surface border border-border rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">21. Data Protection</h2>
            <p className="text-foreground leading-relaxed mb-4">
          ...
          {/* 22. Contact */}
          <section className="bg-surface border border-border rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-4 text-foreground">22. Contact Information</h2>
            <p className="text-foreground leading-relaxed mb-4">
